...
export declare type TrackBaseUnion = TrackBase | AudioTrack | VideoTrack | TextTrack;
...
export declare type AudioUnion = Audio | AacAudio;
...
export declare type ImageUnion = Image | JpgImage | PngImage;
