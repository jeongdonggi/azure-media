...
export class ContentKeyPoliciesImpl {
    /**
    ...
    get(resourceGroupName, accountName, contentKeyPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, contentKeyPolicyName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, accountName, contentKeyPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, contentKeyPolicyName, options }, deleteOperationSpec);
    }
    /**
