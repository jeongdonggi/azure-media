...
export class StreamingPoliciesImpl {
    /**
    ...
    get(resourceGroupName, accountName, streamingPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, streamingPolicyName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, accountName, streamingPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, streamingPolicyName, options }, deleteOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group within the Azure subscription.
