 ...
 */
function listAStreamingEndpointSku() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingEndpoints.skus(resourceGroupName, accountName, streamingEndpointName);
        console.log(result);
    });
}
listAStreamingEndpointSku().catch(console.error);
//# sourceMappingURL=streamingEndpointsSkusSample.js.map