...
function createsATrack() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.tracks.beginCreateOrUpdateAndWait(resourceGroupName, accountName, assetName, trackName, parameters);
        console.log(result);
    });
}
createsATrack().catch(console.error);
//# sourceMappingURL=tracksCreateOrUpdateSample.js.map