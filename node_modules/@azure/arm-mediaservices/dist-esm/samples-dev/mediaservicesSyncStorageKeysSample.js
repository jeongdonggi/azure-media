 ...
 */
function synchronizesStorageAccountKeys() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.mediaservices.syncStorageKeys(resourceGroupName, accountName, parameters);
        console.log(result);
    });
}
synchronizesStorageAccountKeys().catch(console.error);
//# sourceMappingURL=mediaservicesSyncStorageKeysSample.js.map