...
function createALiveOutput() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.liveOutputs.beginCreateAndWait(resourceGroupName, accountName, liveEventName, liveOutputName, parameters);
        console.log(result);
    });
}
createALiveOutput().catch(console.error);
//# sourceMappingURL=liveOutputsCreateSample.js.map