 ...
 */
function getTheStreamingEndpointOperationStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingEndpoints.operationLocation(resourceGroupName, accountName, streamingEndpointName, operationId);
        console.log(result);
    });
}
getTheStreamingEndpointOperationStatus().catch(console.error);
//# sourceMappingURL=streamingEndpointsOperationLocationSample.js.map