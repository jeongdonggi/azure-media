 ...
 */
function getAStreamingPolicyByName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingPolicies.get(resourceGroupName, accountName, streamingPolicyName);
        console.log(result);
    });
}
getAStreamingPolicyByName().catch(console.error);
//# sourceMappingURL=streamingPoliciesGetSample.js.map