 ...
 */
function deleteAStreamingEndpoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingEndpoints.beginDeleteAndWait(resourceGroupName, accountName, streamingEndpointName);
        console.log(result);
    });
}
deleteAStreamingEndpoint().catch(console.error);
//# sourceMappingURL=streamingEndpointsDeleteSample.js.map