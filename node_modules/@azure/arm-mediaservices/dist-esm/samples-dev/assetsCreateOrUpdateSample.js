...
function createAnAsset() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.assets.createOrUpdate(resourceGroupName, accountName, assetName, parameters);
        console.log(result);
    });
}
createAnAsset().catch(console.error);
//# sourceMappingURL=assetsCreateOrUpdateSample.js.map