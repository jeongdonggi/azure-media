 ...
 */
function updateAnAccountFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.accountFilters.update(resourceGroupName, accountName, filterName, parameters);
        console.log(result);
    });
}
updateAnAccountFilter().catch(console.error);
//# sourceMappingURL=accountFiltersUpdateSample.js.map