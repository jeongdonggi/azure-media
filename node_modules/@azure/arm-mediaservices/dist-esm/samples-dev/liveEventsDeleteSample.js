...
function deleteALiveEvent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.liveEvents.beginDeleteAndWait(resourceGroupName, accountName, liveEventName);
        console.log(result);
    });
}
deleteALiveEvent().catch(console.error);
//# sourceMappingURL=liveEventsDeleteSample.js.map