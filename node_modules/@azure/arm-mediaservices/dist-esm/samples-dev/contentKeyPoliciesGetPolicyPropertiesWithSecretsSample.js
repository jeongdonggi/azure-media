 ...
 */
function getAnContentKeyPolicyWithSecrets() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.contentKeyPolicies.getPolicyPropertiesWithSecrets(resourceGroupName, accountName, contentKeyPolicyName);
        console.log(result);
    });
}
getAnContentKeyPolicyWithSecrets().catch(console.error);
//# sourceMappingURL=contentKeyPoliciesGetPolicyPropertiesWithSecretsSample.js.map