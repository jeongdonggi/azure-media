...
function deleteAKeyPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.contentKeyPolicies.delete(resourceGroupName, accountName, contentKeyPolicyName);
        console.log(result);
    });
}
deleteAKeyPolicy().catch(console.error);
//# sourceMappingURL=contentKeyPoliciesDeleteSample.js.map