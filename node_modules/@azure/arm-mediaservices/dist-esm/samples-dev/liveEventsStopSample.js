...
function stopALiveEvent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.liveEvents.beginStopAndWait(resourceGroupName, accountName, liveEventName, parameters);
        console.log(result);
    });
}
stopALiveEvent().catch(console.error);
//# sourceMappingURL=liveEventsStopSample.js.map