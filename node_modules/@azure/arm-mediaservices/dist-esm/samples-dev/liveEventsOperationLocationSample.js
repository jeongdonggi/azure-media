 ...
 */
function getTheLiveEventOperationStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.liveEvents.operationLocation(resourceGroupName, accountName, liveEventName, operationId);
        console.log(result);
    });
}
getTheLiveEventOperationStatus().catch(console.error);
//# sourceMappingURL=liveEventsOperationLocationSample.js.map