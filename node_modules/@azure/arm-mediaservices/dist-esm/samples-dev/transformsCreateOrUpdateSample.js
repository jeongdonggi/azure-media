 ...
 */
function createOrUpdateATransform() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.transforms.createOrUpdate(resourceGroupName, accountName, transformName, parameters);
        console.log(result);
    });
}
createOrUpdateATransform().catch(console.error);
//# sourceMappingURL=transformsCreateOrUpdateSample.js.map