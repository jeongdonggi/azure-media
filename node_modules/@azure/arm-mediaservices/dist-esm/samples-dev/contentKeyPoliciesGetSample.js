 ...
 */
function getAContentKeyPolicyByName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.contentKeyPolicies.get(resourceGroupName, accountName, contentKeyPolicyName);
        console.log(result);
    });
}
getAContentKeyPolicyByName().catch(console.error);
//# sourceMappingURL=contentKeyPoliciesGetSample.js.map