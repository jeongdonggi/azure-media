...
function updateATrack() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.tracks.beginUpdateAndWait(resourceGroupName, accountName, assetName, trackName, parameters);
        console.log(result);
    });
}
updateATrack().catch(console.error);
//# sourceMappingURL=tracksUpdateSample.js.map