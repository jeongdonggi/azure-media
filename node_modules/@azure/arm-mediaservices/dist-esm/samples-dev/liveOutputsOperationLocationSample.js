 ...
 */
function getTheLiveOutputOperationStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.liveOutputs.operationLocation(resourceGroupName, accountName, liveEventName, liveOutputName, operationId);
        console.log(result);
    });
}
getTheLiveOutputOperationStatus().catch(console.error);
//# sourceMappingURL=liveOutputsOperationLocationSample.js.map