 ...
 */
function deleteAStreamingLocator() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingLocators.delete(resourceGroupName, accountName, streamingLocatorName);
        console.log(result);
    });
}
deleteAStreamingLocator().catch(console.error);
//# sourceMappingURL=streamingLocatorsDeleteSample.js.map