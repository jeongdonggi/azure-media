 ...
 */
function scaleAStreamingEndpoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingEndpoints.beginScaleAndWait(resourceGroupName, accountName, streamingEndpointName, parameters);
        console.log(result);
    });
}
scaleAStreamingEndpoint().catch(console.error);
//# sourceMappingURL=streamingEndpointsScaleSample.js.map