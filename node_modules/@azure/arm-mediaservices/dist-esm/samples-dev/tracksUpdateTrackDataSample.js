 ...
 */
function updateTheDataForATracks() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.tracks.beginUpdateTrackDataAndWait(resourceGroupName, accountName, assetName, trackName);
        console.log(result);
    });
}
updateTheDataForATracks().catch(console.error);
//# sourceMappingURL=tracksUpdateTrackDataSample.js.map