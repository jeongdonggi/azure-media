 ...
 */
function deleteAStreamingPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingPolicies.delete(resourceGroupName, accountName, streamingPolicyName);
        console.log(result);
    });
}
deleteAStreamingPolicy().catch(console.error);
//# sourceMappingURL=streamingPoliciesDeleteSample.js.map