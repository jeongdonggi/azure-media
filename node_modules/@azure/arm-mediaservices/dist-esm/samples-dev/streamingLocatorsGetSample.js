 ...
 */
function getAStreamingLocatorByName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingLocators.get(resourceGroupName, accountName, streamingLocatorName);
        console.log(result);
    });
}
getAStreamingLocatorByName().catch(console.error);
//# sourceMappingURL=streamingLocatorsGetSample.js.map