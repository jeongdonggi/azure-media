 ...
 */
function createAnAccountFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.accountFilters.createOrUpdate(resourceGroupName, accountName, filterName, parameters);
        console.log(result);
    });
}
createAnAccountFilter().catch(console.error);
//# sourceMappingURL=accountFiltersCreateOrUpdateSample.js.map