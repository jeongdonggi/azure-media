...
function deleteATransform() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.transforms.delete(resourceGroupName, accountName, transformName);
        console.log(result);
    });
}
deleteATransform().catch(console.error);
//# sourceMappingURL=transformsDeleteSample.js.map