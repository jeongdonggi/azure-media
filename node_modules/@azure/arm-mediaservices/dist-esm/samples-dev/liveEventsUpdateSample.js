...
function updateALiveEvent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.liveEvents.beginUpdateAndWait(resourceGroupName, accountName, liveEventName, parameters);
        console.log(result);
    });
}
updateALiveEvent().catch(console.error);
//# sourceMappingURL=liveEventsUpdateSample.js.map