 ...
 */
function getAMediaServicesAccountByName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.mediaservices.get(resourceGroupName, accountName);
        console.log(result);
    });
}
getAMediaServicesAccountByName().catch(console.error);
//# sourceMappingURL=mediaservicesGetSample.js.map