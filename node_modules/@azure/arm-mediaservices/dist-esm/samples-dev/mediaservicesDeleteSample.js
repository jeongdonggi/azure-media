 ...
 */
function deleteAMediaServicesAccount() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.mediaservices.delete(resourceGroupName, accountName);
        console.log(result);
    });
}
deleteAMediaServicesAccount().catch(console.error);
//# sourceMappingURL=mediaservicesDeleteSample.js.map