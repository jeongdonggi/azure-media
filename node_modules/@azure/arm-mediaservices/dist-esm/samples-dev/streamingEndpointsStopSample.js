 ...
 */
function stopAStreamingEndpoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingEndpoints.beginStopAndWait(resourceGroupName, accountName, streamingEndpointName);
        console.log(result);
    });
}
stopAStreamingEndpoint().catch(console.error);
//# sourceMappingURL=streamingEndpointsStopSample.js.map