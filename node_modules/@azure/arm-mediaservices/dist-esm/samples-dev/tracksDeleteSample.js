...
function deleteATrack() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.tracks.beginDeleteAndWait(resourceGroupName, accountName, assetName, trackName);
        console.log(result);
    });
}
deleteATrack().catch(console.error);
//# sourceMappingURL=tracksDeleteSample.js.map