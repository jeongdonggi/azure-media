...
function listAssetSasUrLs() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.assets.listStreamingLocators(resourceGroupName, accountName, assetName);
        console.log(result);
    });
}
listAssetSasUrLs().catch(console.error);
//# sourceMappingURL=assetsListStreamingLocatorsSample.js.map