...
function deleteAnAssetFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.assetFilters.delete(resourceGroupName, accountName, assetName, filterName);
        console.log(result);
    });
}
deleteAnAssetFilter().catch(console.error);
//# sourceMappingURL=assetFiltersDeleteSample.js.map