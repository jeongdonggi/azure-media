 ...
 */
function getAStreamingEndpointByName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingEndpoints.get(resourceGroupName, accountName, streamingEndpointName);
        console.log(result);
    });
}
getAStreamingEndpointByName().catch(console.error);
//# sourceMappingURL=streamingEndpointsGetSample.js.map