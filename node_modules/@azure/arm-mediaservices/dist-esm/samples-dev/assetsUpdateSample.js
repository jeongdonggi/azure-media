...
function updateAnAsset() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.assets.update(resourceGroupName, accountName, assetName, parameters);
        console.log(result);
    });
}
updateAnAsset().catch(console.error);
//# sourceMappingURL=assetsUpdateSample.js.map