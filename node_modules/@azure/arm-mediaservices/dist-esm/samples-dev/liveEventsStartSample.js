...
function startALiveEvent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.liveEvents.beginStartAndWait(resourceGroupName, accountName, liveEventName);
        console.log(result);
    });
}
startALiveEvent().catch(console.error);
//# sourceMappingURL=liveEventsStartSample.js.map