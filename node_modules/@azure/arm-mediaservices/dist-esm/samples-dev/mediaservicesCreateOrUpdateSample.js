 ...
 */
function createAMediaServicesAccount() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.mediaservices.beginCreateOrUpdateAndWait(resourceGroupName, accountName, parameters);
        console.log(result);
    });
}
createAMediaServicesAccount().catch(console.error);
//# sourceMappingURL=mediaservicesCreateOrUpdateSample.js.map