...
function createAnAssetFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.assetFilters.createOrUpdate(resourceGroupName, accountName, assetName, filterName, parameters);
        console.log(result);
    });
}
createAnAssetFilter().catch(console.error);
//# sourceMappingURL=assetFiltersCreateOrUpdateSample.js.map