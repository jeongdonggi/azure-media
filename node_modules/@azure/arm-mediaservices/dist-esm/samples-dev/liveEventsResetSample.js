...
function resetALiveEvent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.liveEvents.beginResetAndWait(resourceGroupName, accountName, liveEventName);
        console.log(result);
    });
}
resetALiveEvent().catch(console.error);
//# sourceMappingURL=liveEventsResetSample.js.map