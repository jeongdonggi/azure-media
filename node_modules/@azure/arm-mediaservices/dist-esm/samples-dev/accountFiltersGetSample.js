 ...
 */
function getAnAccountFilterByName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.accountFilters.get(resourceGroupName, accountName, filterName);
        console.log(result);
    });
}
getAnAccountFilterByName().catch(console.error);
//# sourceMappingURL=accountFiltersGetSample.js.map