 ...
 */
function listsJobsForTheTransformFilterByCreated() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const filter = "properties/created ge 2021-11-01T00:00:10.0000000Z and properties/created le 2021-11-01T00:00:20.0000000Z";
        ...
        try {
            for (var _b = __asyncValues(client.jobs.list(resourceGroupName, accountName, transformName, options)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
 ...
 */
function listsJobsForTheTransformFilterByLastmodified() {
    var e_2, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = "contosoresources";
        const accountName = "contosomedia";
        const transformName = "exampleTransform";
        const filter = "properties/lastmodified ge 2021-11-01T00:00:10.0000000Z and properties/lastmodified le 2021-11-01T00:00:20.0000000Z";
 ...
 */
function listsJobsForTheTransformFilterByNameAndState() {
    var e_3, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = "contosoresources";
 ...
 */
function listsJobsForTheTransformFilterByName() {
    var e_4, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = "contosoresources";
 ...
 */
function listsJobsForTheTransformFilterByStateEqual() {
    var e_5, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = "contosoresources";
 ...
 */
function listsJobsForTheTransformFilterByStateNotEqual() {
    var e_6, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = "contosoresources";
 ...
 */
function listsAllOfTheJobsForTheTransform() {
    var e_7, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = "contosoresources";
        ...
        const resArray = new Array();
        try {
            for (var _b = __asyncValues(client.jobs.list(resourceGroupName, accountName, transformName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=jobsListSample.js.map